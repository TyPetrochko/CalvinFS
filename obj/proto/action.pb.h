...
class Action : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Action) */ {
 public:
  ...
  bool has_single_replica() const;
  void clear_single_replica();
  static const int kSingleReplicaFieldNumber = 41;
 ...
 private:
  ...
  inline void set_has_single_replica();
  inline void clear_has_single_replica();
...
// required bool single_replica = 41;
inline bool Action::has_single_replica() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void Action::set_has_single_replica() {
  _has_bits_[0] |= 0x00000800u;
}
inline void Action::clear_has_single_replica() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void Action::clear_single_replica() {
  single_replica_ = false;
  clear_has_single_replica();
}
inline bool Action::single_replica() const {
  // @@protoc_insertion_point(field_get:Action.single_replica)
  return single_replica_;
}
inline void Action::set_single_replica(bool value) {
