...
void protobuf_AssignDesc_action_2eproto() {
  ...
  static const int Action_offsets_[19] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Action, single_replica_),
...
void protobuf_AddDesc_action_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\014action.proto\032\014scalar.proto\"\313\003\n\006Action\022"
    ...
    "ion_offset\030  \001(\004\022\026\n\016single_replica\030) \002(\010"
    "\022\021\n\006origin\030* \001(\r:\0010\022\023\n\013distinct_id\030+ \002(\004"
    "\022\034\n\rnew_generated\030, \001(\010:\005false\022\031\n\021involv"
    "ed_replicas\030- \003(\r\022\032\n\013fake_action\030. \001(\010:\005"
...
const int Action::kSingleReplicaFieldNumber;
...
#define ZR_(first, last) do {\
  ...
  if (_has_bits_[8 / 32] & 32256u) {
    ZR_(single_replica_, new_generated_);
    ZR_(version_offset_, distinct_id_);
    version_ = GOOGLE_ULONGLONG(0);
    origin_ = 0u;
  }
  if (_has_bits_[16 / 32] & 327680u) {
    fake_action_ = false;
    action_status_ = 0;
  }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 32: {
        ...
        if (input->ExpectTag(328)) goto parse_single_replica;
        break;
      }
      ...
      case 41: {
        if (tag == 328) {
         parse_single_replica:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   bool, ::google::protobuf::internal::WireFormatLite::TYPE_BOOL>(
                 input, &single_replica_)));
          set_has_single_replica();
        } else {
          goto handle_unusual;
        }
...
void Action::SerializeWithCachedSizes(
  ...
  if (has_single_replica()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(41, this->single_replica(), output);
  }
...
::google::protobuf::uint8* Action::InternalSerializeWithCachedSizesToArray(
  ...
  // required bool single_replica = 41;
  if (has_single_replica()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(41, this->single_replica(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Action)
  ...
  if (((_has_bits_[0] & 0x00002828) ^ 0x00002828) == 0) {  // All required fields are present.
    // required int32 action_type = 12;
    total_size += 1 +
      ::google::protobuf::internal::WireFormatLite::Int32Size(
        this->action_type());
...
// @@protoc_insertion_point(class_specific_merge_from_start:Action)
  ...
  if (from._has_bits_[9 / 32] & (0xffu << (9 % 32))) {
    ...
    if (from.has_single_replica()) {
      set_single_replica(from.single_replica());
    }
    if (from.has_origin()) {
...
bool Action::IsInitialized() const {
  if ((_has_bits_[0] & 0x00002828) != 0x00002828) return false;
...
void Action::InternalSwap(Action* other) {
  ...
  std::swap(single_replica_, other->single_replica_);
...
// required bool single_replica = 41;
bool Action::has_single_replica() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
void Action::set_has_single_replica() {
  _has_bits_[0] |= 0x00000800u;
}
void Action::clear_has_single_replica() {
  _has_bits_[0] &= ~0x00000800u;
}
void Action::clear_single_replica() {
  single_replica_ = false;
  clear_has_single_replica();
}
 bool Action::single_replica() const {
  // @@protoc_insertion_point(field_get:Action.single_replica)
  return single_replica_;
}
 void Action::set_single_replica(bool value) {
  set_has_single_replica();
  single_replica_ = value;
  // @@protoc_insertion_point(field_set:Action.single_replica)
}
